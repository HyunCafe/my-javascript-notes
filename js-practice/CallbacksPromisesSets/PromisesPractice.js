// 1) Create a Promise that resolves with the string "Hello, world!".

// 2) Create a Promise that resolves with a random number between 1 and 10.

// 3) Create a Promise that resolves with the result of adding two numbers passed as arguments to the Promise constructor.
...
// 8) Create a function that takes a string as an argument and returns a Promise that resolves with the same string, but with all vowels replaced with the letter 'x'.